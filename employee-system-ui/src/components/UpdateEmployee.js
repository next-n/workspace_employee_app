        ...
        <div className='px-8 py-8'>
            ...
            <div className='items-center justify-center h-14 w-full my-4'>
                ...
                <input
                 ...
                 className='h-10 w-96 border border-violet-800 border-t-fuchsia-800
                 mt-2 px-2 py-2'></input>
            </div>
            <div className='items-center justify-center h-14 w-full my-4'>
                ...
                onChange={(e) => handleChange(e)}
                className='h-10 w-96 border mt-2 px-2 py-2  border-violet-800 border-t-fuchsia-800'></input>
            </div>
            <div className='items-center justify-center h-14 w-full my-4'>
            ...
            <div className='items-center justify-center h-14 w-full my-4 py-3 space-x-4'>
